=== Premier League Football Team Stats Lite ===
...
Premier League Team Stats allows bloggers display an Premier League team's standings within their sidebar.

== Description ==

Premier League Team Stats plugin can be added to any blog with a dynamic sidebar. Once installed, the blogger can choose their favorite Premier League Team 
and the type of display they want (compact or large). The stats are updated each week of the Premier League regular season, so that blog 
visitors can keep track of all the important Premier League team standings and stats.
...
We have no outward 
preference where our plugin appears, as long as the website content is legal in its particular jurisdiction. This plugin is licensed under WordPress.org guidelines and <a href="http://en.wikipedia.org/wiki/GNU_General_Public_License">General Public License</a>.

== Installation ==

This section describes how to install the plugin and get it working.

1. Upload `premier-league-team-stats-lite` folder to the `/wp-content/plugins/` directory
...
4. Go to your Design section and select the Premier League Stats widget.
...
= Why is there so much "inline" CSS displayed in my Premier League Stats table? =
...
Some people like to post on sports blogs, personal blogs, or <a href="http://uk.sportsbetting3.com">UK sports betting</a> style websites. Websites in foreign languages are fine, too!

= What about gaming & sports pages? =

No problem, feel free to use this plugin on sites that offer legal information about sports gaming, such as <a href="http://uk.sportsbetting3.com/premier_league_betting.php">Premier League Betting</a> blogs. In general, your 
...
1. We're working on getting screenshots. For now, visit http://wplatest5.thoseamazingparks.com to see an example. Note, do not submit your name and request 
the Premier League Stats through the form on this page, since you already have the software. This request form is for users who do not use WP, or would like a simplified version of the Premier League stats plugin.
